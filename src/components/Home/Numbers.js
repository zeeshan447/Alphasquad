...
export const Numbers = () => {
  return (
    <div className=" bg-blue_dark mt-32 pt-12">
      ...
      <div className="flex justify-center items-center space-x-4 text-center mt-32">
        <div className="box-border h-60 w-60 p-4 border-4 border-white rounded-large bg-white">
          <h3 className="text-number_card font-extrabold mt-16">40+</h3>
          <p className="text-number_carddesc mt-4">Happy Clients</p>
        </div>
        <div className="box-border h-60 w-60 p-4 border-4 border-white rounded-large rounded-large bg-white">
